...
const SPECIES={rose:Rose,lotus:Lotus,tulip:Tulip,sunflower:Sunflower,marigold:Marigold,lily:Lily,jasmine:Jasmine,orchid:Orchid,hibiscus:Hibiscus,dahlia:Dahlia,peony:Peony,lavender:Lavender,chrysanthemum:Chrysanthemum,daisy:Daisy,'cherry-blossom':CherryBlossom};
